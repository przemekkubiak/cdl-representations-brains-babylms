...
**GPT-2 on BabyLM, mid data budget** — [`BrainAlign/gpt2-babylm-5`](https://huggingface.co/BrainAlign/gpt2-babylm-5) · 9 epoch checkpoints.
...
|---|---|---|
| brain RSA (mean over checkpoints × 12 cells) | -0.0216 | ❌ confounded |
| brain RSA vs training step | rho 0.142, p 0.142 (n=108) | ❌ confounded |
| interp: participation ratio (effective dim / hidden) | 0.0659 | ✅ |
| interp: gini (activation sparsity) | 0.3235 | ✅ |
| interp: hoyer sparsity | 0.1554 | ✅ |
| interp: CKA to previous checkpoint | 0.9570 | ✅ |
| localisation: selectivity index | 0.5307 | ✅ |
| localisation: mean overlap with other phenomena | 0.0059 | ✅ |
| localisation: active layers | 12.0000 | ✅ |
| localisation: layer centre of mass | 0.5103 | ✅ |
...
- Participation ratio **0.066**: the representation uses ~7% of its available dimensions. Very compressed relative to the other families here.
- Selectivity **0.531** — like every model in this release, phenomena are only moderately isolated. Nothing here shows sharp, dedicated linguistic circuitry.
...
![overview](figures/babylm-gpt2-5_overview.png)
