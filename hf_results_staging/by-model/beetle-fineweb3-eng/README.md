...
**English at a web-scale budget (FineWeb, 24B tokens)** — [`Beetle-FineWeb3-24B/beetle-monolingual-fineweb3-eng`](https://huggingface.co/Beetle-FineWeb3-24B/beetle-monolingual-fineweb3-eng) · 19 step branches.

19 checkpoints, steps 0–65536.
...
|---|---|---|
| brain RSA (mean over checkpoints × 12 cells) | -0.0151 | ❌ confounded |
| brain RSA vs training step | rho -0.052, p 0.436 (n=228) | ❌ confounded |
| interp: participation ratio (effective dim / hidden) | 0.2413 | ✅ |
| interp: gini (activation sparsity) | 0.0896 | ✅ |
| interp: hoyer sparsity | 0.0547 | ✅ |
| interp: CKA to previous checkpoint | 0.8921 | ✅ |
| localisation: selectivity index | 0.5582 | ✅ |
| localisation: mean overlap with other phenomena | 0.0029 | ✅ |
| localisation: active layers | 13.9868 | ✅ |
| localisation: layer centre of mass | 0.5247 | ✅ |
| behaviour: minimal-pair accuracy (chance 0.5) | 0.5904 | ✅ |
| causal selectivity (localized vs random ablation) | 0.0136 | ✅ |

## What this model shows

- Minimal-pair accuracy **0.590**, modestly above chance.
- Participation ratio **0.241**: the representation uses ~24% of its available dimensions. Mid-range for this release.
- Selectivity **0.558** — like every model in this release, phenomena are only moderately isolated. Nothing here shows sharp, dedicated linguistic circuitry.
...
![overview](figures/beetle-fineweb3-eng_overview.png)
