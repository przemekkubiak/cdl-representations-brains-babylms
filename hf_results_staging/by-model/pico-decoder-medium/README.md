...
**pico decoder, medium of the scale ladder** — [`pico-lm/pico-decoder-medium`](https://huggingface.co/pico-lm/pico-decoder-medium) · dense commit-history checkpoints.
...
|---|---|---|
| brain RSA (mean over checkpoints × 12 cells) | -0.0111 | ❌ confounded |
| brain RSA vs training step | rho -0.096, p 0.129 (n=252) | ❌ confounded |
| interp: participation ratio (effective dim / hidden) | 0.1912 | ✅ |
| interp: gini (activation sparsity) | 0.2064 | ✅ |
| interp: hoyer sparsity | 0.3034 | ✅ |
| interp: CKA to previous checkpoint | 0.8149 | ✅ |
| localisation: selectivity index | 0.5444 | ✅ |
| localisation: mean overlap with other phenomena | 0.0060 | ✅ |
| localisation: active layers | 11.9881 | ✅ |
| localisation: layer centre of mass | 0.5333 | ✅ |
| behaviour: minimal-pair accuracy (chance 0.5) | 0.6786 | ✅ |

## What this model shows

- Minimal-pair accuracy **0.679**, clearly above chance — the model has learned the contrasts being probed.
- Participation ratio **0.191**: the representation uses ~19% of its available dimensions. Mid-range for this release.
- Selectivity **0.544** — like every model in this release, phenomena are only moderately isolated. Nothing here shows sharp, dedicated linguistic circuitry.
...
![overview](figures/pico-decoder-medium_overview.png)
