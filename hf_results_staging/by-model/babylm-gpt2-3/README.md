...
**GPT-2 on BabyLM, smallest data budget** — [`BrainAlign/gpt2-babylm-3`](https://huggingface.co/BrainAlign/gpt2-babylm-3) · 9 epoch checkpoints.
...
|---|---|---|
| brain RSA (mean over checkpoints × 12 cells) | -0.0209 | ❌ confounded |
| brain RSA vs training step | rho 0.175, p 0.071 (n=108) | ❌ confounded |
| interp: participation ratio (effective dim / hidden) | 0.0653 | ✅ |
| interp: gini (activation sparsity) | 0.3260 | ✅ |
| interp: hoyer sparsity | 0.1573 | ✅ |
| interp: CKA to previous checkpoint | 0.9551 | ✅ |
| localisation: selectivity index | 0.5191 | ✅ |
| localisation: mean overlap with other phenomena | 0.0078 | ✅ |
| localisation: active layers | 12.0000 | ✅ |
| localisation: layer centre of mass | 0.5134 | ✅ |
| behaviour: minimal-pair accuracy (chance 0.5) | 0.6933 | ✅ |

## What this model shows

- Minimal-pair accuracy **0.693**, clearly above chance — the model has learned the contrasts being probed.
- Participation ratio **0.065**: the representation uses ~7% of its available dimensions. Very compressed relative to the other families here.
...
![overview](figures/babylm-gpt2-3_overview.png)
